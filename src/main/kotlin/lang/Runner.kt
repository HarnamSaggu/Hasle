...
class Runner(mainMethod: MainMethod, methodDeclarations: List<MethodDeclaration>, args: List<String>) {
	...
	private fun runMethod(methodCall: MethodCall, stackLevel: Pair<Int, Int>): Data {
		...
		val definedMethod = definedMethods[methodCall.methodName]
